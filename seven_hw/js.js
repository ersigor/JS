...
const snake = {
    ...
    growUp() {
        ...
        score_num.innerHTML = (lastBodyIndex + 1).toString();
...
const game = {
    ...
    reset() {
        ...
        this.rock.setCoordinates(this.getRandomFreeCoordinatesRock());
        this.render();
    },
    ...
    newGameClickHandler() {
        this.reset();
        let score_num = document.getElementById('score_num')
        score_num.innerHTML = 'Здесь будет счет';
    },
